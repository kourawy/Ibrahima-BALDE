...
function ChoixSelection(idListe, indice, nbEtoile){
	...
	document.getElementById(score).innerHTML = " " + indice;
}
...
function CreateListeEtoile(idListe, nbEtoile){
	...
	for(i=1; i<=nbEtoile; i++){
		...
		renduListe += "<img id=\"staroff-" + idListe + "-" + i + "\" src=\"images/staroff.gif\" border=\"0\" title=\"" + i + "\" style=\"border-width: 0px; display: block;\">";
		renduListe += "<img id=\"staron-" + idListe + "-" + i + "\" src=\"images/staron.gif\" border=\"0\" title=\"" + i + "\" style=\"border-width: 0px; display: none;\">";
		renduListe += "</a>";
		renduListe += "</li>";
	}
